...
project = u'Ananas\'s BLOG' 
copyright = u'2018, Dark'
...
latex_documents = [
  ('index', 'python3-cookbook.tex', u'AnanasRobot BLOG',
   u'Dark', 'howto'),
]
...
man_pages = [
    ('index', 'AnanasRobot BLOG', u'AnanasRobot BLOG',
     [u'Dark'], 1)
]
...
texinfo_documents = [
  ('index', 'AnanasRobot', u'AnanasRobot BLOG',
   u'Dark', 'AnanasRobot', 'AnanasRobot BLOG',
   'Miscellaneous'),
]
